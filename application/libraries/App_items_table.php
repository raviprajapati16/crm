...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
             ...
             * Item quantity
             */
            //$itemHTML .= '<td align="right">' . $item['hsn_code'].'</td>';
            // $itemHTML .= '<td align="right">' . $item['capacity'].'</td>';
    ...
    public function html_headings()
    {
        ...
        $html .= '<th class="description" width="30%" align="left">' . $this->item_heading() . '</th>';

        $custom_fields = $this->get_custom_fields_for_table();
        foreach ($custom_fields as $cf) {
            $html .= '<th class="custom_field" align="left">' . $cf['name'] . '</th>';
        }
        //$html .= '<th align="right">HSN Code</th>';
        // $html .= '<th align="right">Capacity</th>';
    ...
    public function pdf_headings()
    {
        ...
        // $tblhtml .= '<th width="12%" align="right">Capacity</th>';
        $tblhtml .= '<th width="7%" align="right">' . $this->qty_heading() . '</th>';
