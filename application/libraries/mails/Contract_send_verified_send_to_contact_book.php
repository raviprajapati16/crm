...
class Contract_send_verified_send_to_contact_book extends App_mail_template
{
    protected $for = 'contact_book';

    protected $contract;

    protected $contact;

    public $slug = 'send-contract-verified-to-contact-book-user';

    public $rel_type = 'contract';

    public function __construct($contract, $contact, $cc = '', $reply_to = '')
    {
        parent::__construct();
    ...
    public function build()
    {
        ...
        $this->to($this->contact->email)
            ...
            ->set_merge_fields('contact_book_merge_fields', $this->contract->client)
