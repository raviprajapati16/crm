...
class Contract_expiration_reminder_to_vendor extends App_mail_template
{
    ...
    public $slug = 'contract-expiration-to-vendor';
    ...
    public function __construct($contract, $contact)
    {
        ...
        $this->set_merge_fields('vendors_merge_fields', $this->contract['client']);
