...
class Contract_expiration_reminder_to_contact_book extends App_mail_template
{
    protected $for = 'contact-book';

    protected $contract;

    protected $contact;

    public $slug = 'contract-expiration-to-contact-book-user';
