...
class Staff_merge_fields extends App_merge_fields
{
    public function build()
    {
        ...
        [
                ...
                [
                    ...
                    'key'       => '{customer_name}',
                    'templates' => [
                        'reminder-customer-meeting-email-send',
                    ],
                ],
                [
                    'name'      => 'Online Meeting Time',
                    'key'       => '{meeting_time}',
                    'templates' => [
                        'reminder-customer-meeting-email-send',
                    ],
    ...
    */
    public function format($staff_id, $password = '')
    {
        ...
        $fields['{staff_phone}']       = $staff->phonenumber;
    ...
    public function meeting_email_to_customer($reminder,$lead)
    {
        $reminder = (object) $reminder;
        $fields['{customer_name}'] = $lead->name;
        $fields['{meeting_time}'] = date('d/m/Y H:i:s',strtotime($reminder->date));
        $fields['{meeting_platform}'] = $reminder->meeting_platform;
        $fields['{meeting_link}'] = $reminder->meeting_link;
        $fields['{product_name}'] = $lead->product_name;
        return hooks()->apply_filters('staff_reminder_merge_fields', $fields, [
            'reminder' => $reminder,
        ]);
    }
