...
class App_bulk_pdf_export
{
    ...
    public function __construct($config)
    {
        ...
        if (
            in_array($this->type, $this->status_param_required)
    ...
    private function payments()
    {
        ...
        $this->ci->db->where(db_prefix() . 'invoices.deleted_at IS NULL');
        $this->ci->db->where(db_prefix() . 'invoicepaymentrecords.deleted_at IS NULL');
        $this->ci->db->where(db_prefix() . 'clients.deleted_at IS NULL');
        ...
        foreach ($data as $payment) {
            ...
            $pdf = payment_mpdf($payment_data, $this->pdf_tag);
    ...
    private function estimates()
    {
        ...
        foreach ($data as $estimate) {
            ...
            $pdf      = estimate_mpdf($estimate, $this->pdf_tag);
    ...
    private function invoices()
    {
        ...
        foreach ($data as $invoice) {
            ...
            $pdf     = invoice_mpdf($invoice, $this->pdf_tag);
    ...
    public function proposals()
    {
        ...
        foreach ($data as $proposal) {
            ...
            $pdf      = proposal_mpdf($proposal, $this->pdf_tag);
    ...
    public function credit_notes()
    {
        ...
        foreach ($data as $credit_note) {
            ...
            $pdf         = credit_note_mpdf($credit_note, $this->pdf_tag);
