...
class Emails_model extends App_Model
{
    ...
    public function get_with_order($where = [], $result_type = 'result_array')
    {
        $this->db->where($where);
    ...
    public function update($data)
    {
        ...
        foreach ($data['subject'] as $id => $val) {
            ...
            // Two factor authentication email template doesn't have fromemail
            ...
            // Update the email template record
            $this->db->where('emailtemplateid', $id);
