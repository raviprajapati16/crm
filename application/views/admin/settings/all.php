...
<script>
  $(function() {
    ...
    $(document).on('change', '#onofftime', function() {
      if (this.checked) {
        $('.timeSection').removeClass('hide');
      } else {
        $('.timeSection').addClass('hide');
      }
    });
    $('#onofftime').trigger('change');



    // Handle email campaign time sections visibility
    function toggleTimeSections() {
      if ($('#onofftime').is(':checked')) {
        $('.timeSection').show();
      } else {
        $('.timeSection').hide();
      }
    ...
    // Handle expense receipt sections visibility
    function toggleReceiptSections() {
      if ($('#expense_receipt_required').is(':checked')) {
        $('.receiptSection').show();
      } else {
        $('.receiptSection').hide();
      }
    ...
    $('#onofftime').change(function() {
      toggleTimeSections();
    });

    $('#expense_receipt_required').change(function() {
      toggleReceiptSections();
    });

    $('input[name="settings[expense_receipt_amount_threshold]"]').on('input', function() {
