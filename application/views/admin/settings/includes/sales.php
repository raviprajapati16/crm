...
<div class="horizontal-scrollable-tabs">
   ...
   <div class="horizontal-tabs">
      <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
         ...
         <li role="presentation">
            <a href="#debit_notes" aria-controls="debit_notes" role="tab" data-toggle="tab">Debit Notes</a>
         </li>
         <!-- <li role="presentation">
...
<div class="tab-content">
   ...
   <div role="tabpanel" class="tab-pane" id="debit_notes">
      <div class="form-group">
         <label class="control-label" for="debit_note_prefix">Debit Note Number Prefix</label>
         <input type="text" name="settings[debit_note_prefix]" id="debit_note_prefix" class="form-control" value="<?php echo get_option('debit_note_prefix'); ?>">
      </div>
      <hr />
      <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="<?php echo _l('settings_sales_next_invoice_number_tooltip'); ?>"></i>
      <?php echo render_input('settings[next_debit_note_number]', 'Next Debit Note Number', get_option('next_debit_note_number'), 'number', ['min' => 1]); ?>
      <hr />
      <div class="form-group">
         <label for="debit_note_number_format" class="control-label clearfix">Debit Note Number Format</label>
         <div class="radio radio-primary radio-inline">
            <input type="radio" name="settings[debit_note_number_format]" value="1" id="cn_number_based" <?php if (get_option('debit_note_number_format') == '1') {
                                                                                                               echo 'checked';
                                                                                                            } ?>>
            <label for="cn_number_based"><?php echo _l('settings_sales_invoice_number_format_number_based'); ?></label>
         </div>
         <div class="radio radio-primary radio-inline">
            <input type="radio" name="settings[debit_note_number_format]" value="2" id="cn_year_based" <?php if (get_option('debit_note_number_format') == '2') {
                                                                                                            echo 'checked';
                                                                                                         } ?>>
            <label for="cn_year_based"><?php echo _l('settings_sales_invoice_number_format_year_based'); ?> (YYYY/000001)</label>
         </div>
         <div class="radio radio-primary radio-inline">
            <input type="radio" name="settings[debit_note_number_format]" value="3" id="cn_short_year_based" <?php if (get_option('debit_note_number_format') == '3') {
                                                                                                                  echo 'checked';
                                                                                                               } ?>>
            <label for="cn_short_year_based">000001-YY</label>
         </div>
         <div class="radio radio-primary radio-inline">
            <input type="radio" name="settings[debit_note_number_format]" value="4" id="cn_year_month_based" <?php if (get_option('debit_note_number_format') == '4') {
                                                                                                                  echo 'checked';
                                                                                                               } ?>>
            <label for="cn_year_month_based">000001/MM/YYYY</label>
         </div>
      ...
      <hr />
      <?php render_yes_no_option('debit_note_number_decrement_on_delete', 'Decrement debit note number on delete.', 'Number will be decremented only if is last debit note created.'); ?>
      <hr />
      <?php echo render_textarea('settings[predefined_clientnote_debit_note]', 'Predefined Client Note', get_option('predefined_clientnote_debit_note'), array('rows' => 6)); ?>
      <?php echo render_textarea('settings[predefined_terms_debit_note]', 'Predefined Terms & Conditions', get_option('predefined_terms_debit_note'), array('rows' => 6)); ?>
   </div>
         ...
         <div class="col-md-5">
            <div class="mtop30 text-right">
               <div class="radio radio-inline radio-primary">
                  <input type="radio" id="k_desc_estimate" name="settings[default_estimates_pipeline_sort_type]" value="asc" <?php if (get_option('default_estimates_pipeline_sort_type') == 'asc') {
                                                                                                                                 echo 'checked';
                                                                                                                              } ?>>
                  <label for="k_desc_estimate"><?php echo _l('order_ascending'); ?></label>
               </div>
               <div class="radio radio-inline radio-primary">
                  <input type="radio" id="k_asc_estimate" name="settings[default_estimates_pipeline_sort_type]" value="desc" <?php if (get_option('default_estimates_pipeline_sort_type') == 'desc') {
                                                                                                                                 echo 'checked';
                                                                                                                              } ?>>
   ...
   <div role="tabpanel" class="tab-pane" id="proposals">
      ...
      <div class="row">
         ...
         <div class="col-md-5">
            <div class="mtop30 text-right">
               <div class="radio radio-inline radio-primary">
                  <input type="radio" id="k_desc_proposal" name="settings[default_proposals_pipeline_sort_type]" value="asc" <?php if (get_option('default_proposals_pipeline_sort_type') == 'asc') {
                                                                                                                                 echo 'checked';
                                                                                                                              } ?>>
                  <label for="k_desc_proposal"><?php echo _l('order_ascending'); ?></label>
               </div>
               <div class="radio radio-inline radio-primary">
                  <input type="radio" id="k_asc_proposal" name="settings[default_proposals_pipeline_sort_type]" value="desc" <?php if (get_option('default_proposals_pipeline_sort_type') == 'desc') {
                                                                                                                                 echo 'checked';
                                                                                                                              } ?>>
