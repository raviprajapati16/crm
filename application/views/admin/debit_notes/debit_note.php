        ...
        <div class="panel_s debit_note accounting-template">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="f_client_id">
                  <div class="form-group select-placeholder">
                    ...
                    <select id="vendorid" name="vendorid" data-live-search="true" data-width="100%" class="ajax-search<?php if (isset($debit_note) && empty($debit_note->vendorid)) {
                                                                                                                        echo ' vendor-removed';
                                                                                                                      } ?>" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                      <?php $selected = (isset($debit_note) ? $debit_note->vendorid : '');
                      if ($selected != '') {
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php include_once(APPPATH . 'views/admin/debit_notes/billing_and_shipping_template.php'); ?>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="number">Debit Note #</label>
              ...
              <div class="col-md-6">
                <div class="panel_s no-shadow">
                  ...
                  <?php echo render_input('reference_no', 'Reference #', $value); ?>
                  <?php $value = (isset($debit_note) ? $debit_note->adminnote : ''); ?>
                  <?php echo render_textarea('adminnote', 'Admin Note', $value); ?>
          ...
          <div class="panel-body mtop10">
              ...
              <!-- <div class="col-md-8 text-right show_quantity_as_wrapper">
                <div class="mtop10">
                  ...
                  <div class="radio radio-primary radio-inline">
                    <input type="radio" value="1" id="sq_1" name="show_quantity_as" data-text="Qty" <?php if (isset($debit_note) && $debit_note->show_quantity_as == 1) {
                                                                                                      echo 'checked';
                  ...
                  <div class="radio radio-primary radio-inline">
                    <input type="radio" value="2" id="sq_2" name="show_quantity_as" data-text="Hours" <?php if (isset($debit_note) && $debit_note->show_quantity_as == 2 || isset($hours_quantity)) {
                                                                                                        echo 'checked';
                                                                                                      } ?>>
                    <label for="sq_2"><?php echo _l('quantity_as_hours'); ?></label>
                  </div>
                  <div class="radio radio-primary radio-inline">
                    <input type="radio" value="3" id="sq_3" name="show_quantity_as" data-text="Qty/Hours" <?php if (isset($debit_note) && $debit_note->show_quantity_as == 3 || isset($qty_hrs_quantity)) {
                                                                                                            echo 'checked';
                                                                                                          } ?>>
            ...
            <div class="table-responsive s_table">
              <table class="table debite-note-items-table items table-main-debit-note-edit has-calculations no-mtop">
                <thead>
                  <tr>
                    <th></th>
                    <th width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> Item</th>
          ...
          <div class="row">
            <div class="col-md-12 mtop15">
              <div class="panel-body bottom-transaction">
                <?php $value = (isset($debit_note) ? $debit_note->clientnote : get_option('predefined_clientnote_debit_note')); ?>
                <?php echo render_textarea('clientnote', 'Client Note', $value, array(), array(), 'mtop15'); ?>
                <?php $value = (isset($debit_note) ? $debit_note->terms : get_option('predefined_terms_debit_note')); ?>
                <?php echo render_textarea('terms', 'terms_and_conditions', $value, array(), array(), 'mtop15'); ?>
                <div class="btn-bottom-toolbar text-right">
                  <button type="button" class="btn-tr btn btn-info mleft10 debit-note-form-submit save-and-send transaction-submit">
                    <?php echo _l('save_and_send'); ?>
                  </button>
                  <button class="btn-tr btn btn-info mleft10 text-right debit-note-form-submit transaction-submit">
                    <?php echo _l('submit'); ?>
                  </button>
                </div>
              </div>
...
<script>
  $(function() {
    init_ajax_search('vendor', '#vendorid.ajax-search', undefined, admin_url + 'misc/get_relation_data');
  ...
  function validate_debit_note_form(selector) {
    ...
    appValidateForm($(selector), {
      vendorid: {
        required: {
          depends: function() {
            var vendorRemoved = $('select#vendorid').hasClass('vendor-removed');
    ...
    $('body').on('change', '#vendorid', function() {
      if ($(this).val() != '') {
        $.get(admin_url + 'purchase/get_relation_data_values/' + $(this).val(), function(response) {
          $('input[name="include_shipping"]').prop('checked', true).trigger('change');
          $('textarea[name="billing_street"],textarea[name="shipping_street"]').val(response.address);
          $('input[name="billing_city"],input[name="shipping_city"]').val(response.city);
          $('input[name="billing_state"],input[name="shipping_state"]').val(response.state);
          $('input[name="billing_zip"],input[name="shipping_zip"]').val(response.zip);
          $('select[name="billing_country"],select[name="shipping_country"]').selectpicker('val', response.country);
          $('.save-shipping-billing').trigger('click');
        }, 'json');
      }
    });
    ...
    $("body").find('input[name="number"]').rules('add', {
      remote: {
        url: admin_url + "debit_notes/validate_number",
        type: 'post',
        data: {
          number: function() {
