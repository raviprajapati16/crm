...
<div id="wrapper">
                                 ...
                                 <div class="col-md-5 mbot15">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group">
                                          <input type="file" extension="<?php echo str_replace('.','',get_option('ticket_attachments_file_extensions')); ?>" filesize="<?php echo file_upload_max_size(); ?>" class="form-control" name="attachments[0]" accept="<?php echo get_option('ticket_attachments_file_extensions'); ?>">
   ...
   <div class="col-md-9">
      ...
      <?php if(count($ticket->attachments) > 0){
        ...
        ?>
        <a target="_blank" href="<?php echo site_url('download/file/ticket/'. $attachment['id']); ?>" class="display-block mbot5">
