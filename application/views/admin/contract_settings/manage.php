            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <?= form_open(
                            admin_url('contract_settings/save'),
                            array(
                                'id' => 'contractForm'
                            )
                        ) ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="section-title">Agreement Settings</h4>
                                <hr>
                            </div>
                        </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#prefixVariables" aria-expanded="false"
                                                aria-controls="prefixVariables">
                                    ...
                                    <div id="prefixVariables" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <p class="text-muted">Click on any variable below to insert it into the
                                                Agreement Number Prefix at your cursor position:</p>
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button"
                                                                    class="btn btn-xs btn-primary variable-insert"
                                                                    data-variable="{current_full_year}"
                                                                    data-target="contract_number_prefix">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><strong><?php echo $current_month_short; ?></strong>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><strong><?php echo $financial_year_full; ?></strong>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><strong><?php echo $financial_year_short; ?></strong>
                                                            </td>
                                                            <td>Financial year (Apr-Mar)</td>
                                                            <td>
                                                                <button type="button"
                                            ...
                                            <div class="alert alert-info">
                                                ...
                                                <strong>Example:</strong> Using prefix "CON-{financial_year_short}"
                                                would generate:
                                                <strong>CON-<?php echo $financial_year_short; ?></strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="contract_number_prefix">Agreement Number Prefix</label>
                                    <input type="text" class="form-control" id="contract_number_prefix"
                                        name="contract_number_prefix"
                                        value="<?= get_option('contract_number_prefix') ?>">
                                    <small class="text-muted">Use variables above to create dynamic prefixes. Example:
                                        CON-{current_full_year}-</small>
                                </div>
                            </div>
                        </div>
...
$(function() {
    ...
    // $('#contractForm').appFormValidator({
    //     rules: {
    //         contract_number_prefix: 'required',
    //     },
