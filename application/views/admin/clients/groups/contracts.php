...
<a href="<?php echo admin_url('contracts/contract?customer_id='.$client->userid); ?>" class="btn btn-info mbot25<?php if($client->active == 0){echo ' disabled';} ?>">New Agreement</a>
<div class="clearfix"></div>
<input type="hidden" id="only_customer" value="1"/>
<?php } ?>
