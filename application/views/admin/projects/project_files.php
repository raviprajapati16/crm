...
<table class="table dt-table scroll-responsive table-project-files" data-order-col="7" data-order-type="desc">
  <thead>
    <tr>
      <th data-orderable="false"><span class="hide"> - </span>
        <div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="project-files"><label></label></div>
      </th>
  ...
  <tbody>
    ...
    <?php foreach ($other_files as $file) {
      ...
      $attachment_url = site_url('download/file/sales_attachment/' . $file['attachment_key']);
    ?>
      <tr>
        <td>
        ...
        <td>
          <a href="<?= $attachment_url ?>" target="_blank"><?php echo $file['file_name']; ?> <small class='text-muted'>From <?= $file['rel_type'] ?></small></a>
        </td>
