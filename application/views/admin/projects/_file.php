            ...
            <div class="row">
               <div class="col-md-8 border-right project_file_area">
                  ...
                  <?php } else if(strpos($file->filetype,'pdf') !== false && empty($file->external)){
                     $path = site_url('download/file_download?path=uploads/projects/'.$file->project_id.'/'.$file->file_name) ;
                     ?>
                     <a href="<?= $path ?>" target="_blank" class="btn btn-primary">Click here for Preview</a>
