      ...
      <div class="panel-body">
        ...
        <?php } ?>
               ...
               <div class="col-md-6" id="expenseReceipt">
                  ...
                  <div class="row">
                     <div class="col-md-10">
                        <i class="<?php echo get_mime_class($expense->filetype); ?>"></i> <a target="_blank" href="<?php echo site_url('download/file/expense/'.$expense->expenseid); ?>"> <?php echo $expense->attachment; ?></a>
                     </div>
