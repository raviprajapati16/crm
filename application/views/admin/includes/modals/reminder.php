...
<div class="modal fade modal-reminder reminder-modal-<?php echo $name; ?>-<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static">
