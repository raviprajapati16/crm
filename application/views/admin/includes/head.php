...
<head>
    ...
    <script>
        ...
        billingAndShippingFields = ['billing_buyer','billing_street','billing_city','billing_state','billing_zip','billing_country','shipping_notify_party','shipping_street','shipping_city','shipping_state','shipping_zip','shipping_country'],
