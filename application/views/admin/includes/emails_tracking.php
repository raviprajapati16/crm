         ...
         <tbody>
            ...
            foreach ($tracked_emails as $email) { ?>
               <tr>
                  ...
                  <td>
                     <a data-toggle="tooltip" class="btn btn-default" data-placement="top" title="" href="javascript:;" data-original-title="View Emails" onclick="openEmailBodyViewer(<?= $email['id'] ?>)">
                        <i class="fa fa-eye"></i>
                     </a>
                  </td>
               </tr>
