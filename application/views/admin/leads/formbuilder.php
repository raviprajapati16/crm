                        ...
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <div class="duplicate-settings-wrapper row<?php if (isset($form) && $form->allow_duplicate == 1 || !isset($form)) {
                                 ...
                                 <div class="col-md-12">
                                    <div class="checkbox checkbox-primary">
                                       <input type="checkbox" name="create_reminder_on_duplicate" id="create_reminder_on_duplicate" <?php if (isset($form) && $form->create_reminder_on_duplicate == 1 || !isset($form)) {
                                                                                                                                 echo 'checked';
                                                                                                                              } ?>>
                                       <label for="create_reminder_on_duplicate"><i class="fa fa-question-circle" data-toggle="tooltip" data-title="Create duplicate Reminder if leads already exists"></i>Create duplicate Reminder if leads already exists</label>
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="checkbox checkbox-primary">
                                       <input type="checkbox" name="send_brochure_email" id="send_brochure_email" value="1" <?php if (isset($form) && $form->send_brochure_email == '1') {
                                                                                                                     echo 'checked';
                                                                                                                  } ?>>
                                       <label for="send_brochure_email">Send Company brochure email on form submit.</label>
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="checkbox checkbox-primary">
                                       <input type="checkbox" name="company_theme" id="company_theme" value="1" <?php if (isset($form) && $form->company_theme == '1') {
                                                                                                                     echo 'checked';
                                                                                                                  } ?>>
                                       <label for="company_theme">Show form design as per company theme</label>
                                    </div>
                                 </div>
                                 <div class="col-md-12 <?= (isset($form) && $form->company_theme == '0') ? 'hide': ''; ?>">
                                    <?php echo render_input('theme_form_title', 'Theme Form Header Title', (isset($form) && $form->theme_form_title) ? $form->theme_form_title : ""); ?>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
...
<script>
   $(function() {
      ...
      $(document).on('change', 'input[name="company_theme"]', function() {
         $('#theme_form_title').val("")
         if (this.checked) {
            $('#theme_form_title').closest(".col-md-12").removeClass('hide');
         } else {
            $('#theme_form_title').closest(".col-md-12").addClass('hide');
         }
      });

      var formBuilder = $(buildWrap).formBuilder(fbOptions);
      var $create_reminder_on_duplicate = $('#create_reminder_on_duplicate');
         ...
         responsible: {
            required: {
               depends: function(element) {
                  ...
                  var isRequiredByAssignTask = ($create_reminder_on_duplicate.is(':checked')) ? true : false;
      ...
      $create_reminder_on_duplicate.on('change', function() {
         $('#form_info').validate().checkForm()
      });

      $create_reminder_on_duplicate.trigger('change');
