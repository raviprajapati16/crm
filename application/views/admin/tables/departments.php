...
// Remove departmentid from columns
$aColumns = [
    'name',
    'email',
    'calendar_id',
];
$sIndexColumn = 'departmentid'; // still needed as index
...
foreach ($rResult as $aRow) {
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        if ($aColumns[$i] == 'name') {
            $_data = '<a href="#" onclick="edit_department(this,' . $aRow['departmentid'] . '); return false" 
                data-name="' . $aRow['name'] . '" 
