                        ...
                        ?>
                           <div class="mbot15 row col-md-12" data-attachment-id="<?php echo $attachment['id']; ?>">
                              <div class="col-md-8">
                                 ...
                                 <a href="<?php echo $attachment_url; ?>" target="_blank"><?php echo $attachment['file_name']; ?> <?= ($attachment['rel_type'] != "estimate") ? "<small class='text-muted'>From " . $attachment['rel_type'] . "</small>" : "" ?></a>
                                 <br />
                              ...
                              <div class="col-md-4 text-right">
                                 ...
                                 ?>
                                 <?php if ($attachment['rel_type'] == "estimate") { ?>
