            ...
            <div class="mtop10">
                ...
                <div class="radio radio-primary radio-inline">
                    <input type="radio" value="1" id="1" name="show_quantity_as"
                        ...
                        <?php if (isset($estimate) && $estimate->show_quantity_as == 1) {
                                                                                                                                                echo 'checked';
                                                                                                                                             } else {
                                                                                                                                                echo 'checked';
                                                                                                                                             } ?>>
                ...
                <div class="radio radio-primary radio-inline">
                    <input type="radio" value="2" id="2" name="show_quantity_as"
                        ...
                        <?php if (isset($estimate) && $estimate->show_quantity_as == 2) {
                                                                                                                                             echo 'checked';
                                                                                                                                          } ?>>
                ...
                <div class="radio radio-primary radio-inline">
                    <input type="radio" id="3" value="3" name="show_quantity_as"
                        ...
                        <?php if (isset($estimate) && $estimate->show_quantity_as == 3) {
                                                                                                                                                                                                   echo 'checked';
                                                                                                                                                                                                } ?>>
                    <label
                        for="3"><?php echo _l('estimate_table_quantity_heading'); ?>/<?php echo _l('estimate_table_hours_heading'); ?></label>
                </div>
            </div>
        </div>
    </div>
        ...
        <table class="table estimate-items-table items table-main-estimate-edit has-calculations no-mtop">
            ...
            <tbody>
               ...
               foreach ($add_items as $item) {
                  ...
                  //$table_row .= '<td><input type="text" placeholder="Capacity" name="'.$items_indicator.'['.$i.'][capacity]" class="form-control" value="'.$item['capacity'].'"></td>';
                    ...
                    <td colspan="2">
                        ...
                        if (isset($dynamic_amount_fields) && !empty($dynamic_amount_fields)) {
                           foreach ($dynamic_amount_fields as $index => $field) {
                              ...
                              echo '<input type="hidden" name="dynamic_fields[' . $index . '][id]" class="form-control" value="' . $field['id'] . '" required>';
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                              ...
                              foreach ($taxes as $tax) {
                                 $rel_type = $is_proposal ? "proposal" : "invoice";
