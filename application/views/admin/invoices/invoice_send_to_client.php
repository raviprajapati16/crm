                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="checkbox checkbox-primary">
                            <input type="checkbox" name="attach_tax_invoice" id="attach_tax_invoice" checked>
                            <label for="attach_tax_invoice">Attach Tax Invoice PDF</label>
                        </div>
                        <div class="checkbox checkbox-primary">
                            <input type="checkbox" name="attach_packing_list" id="attach_packing_list" checked>
                            <label for="attach_packing_list">Attach Packing / Weight List PDF</label>
                        </div>
                        <div class="checkbox checkbox-primary">
