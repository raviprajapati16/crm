                    ...
                    <div class="pull-right">
                        ...
                        <div class="btn-group">
                            <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">Tax Invoice <span class="caret"></span></a>
                        ...
                        <?php if (!empty($invoice->clientid)) { ?>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <?php } ?>
                                    <?php if (
                                        !in_array($invoice->status, array(Invoices_model::STATUS_PAID, Invoices_model::STATUS_CANCELLED, Invoices_model::STATUS_DRAFT))
                    ...
                    <div class="row mtop15 mbot15">
                        <div class="col-md-6">
                            <div class="checkbox checkbox-primary">
                                <input type="checkbox" name="notify_via_email" id="notify_via_email_inv" value="yes">
                                <label for="notify_via_email_inv">Email Notification</label>
                            </div>
                            <div class="checkbox checkbox-primary">
                                <input type="checkbox" name="notify_via_whatsapp" id="notify_via_whatsapp_inv" value="yes">
                                <label for="notify_via_whatsapp_inv">WhatsApp Notification</label>
                            </div>
                        </div>
...
<script>
    ...
    function invoice_preview(type) {
        ...
        $.ajax({
            url: "<?php echo admin_url('invoices/preview') ?>",
            method: "POST",
            data: {
