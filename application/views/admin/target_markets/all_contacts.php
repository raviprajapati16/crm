      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
              ...
              <div class="row mbot15">
                <div class="col-md-3 contacts-filter-column">
                  <div class="select-placeholder">
                    <select name="custom_view" title="<?php echo _l('gdpr_consent'); ?>" id="custom_view"
            ...
            <?php
            // New column order: Company → Email → Name → Phone → Position → Last Login → Active (+ Consent if enabled)
            
            $table_data = array(
              _l('clients_list_company'),
              _l('client_email'),
              'Client Name', // merged First + Last Name
...
<?php init_tail(); ?>
<?php $this->load->view('admin/target_markets/target_market_js'); ?>
      ...
      <?php if (is_gdpr() && get_option('gdpr_enable_consent_for_contacts') == '1') { ?>
        _table_api.on('draw', function () {
          ...
          $.each(tableData, function () {
            $(this).find('td:eq(2)').addClass('bg-light-gray'); // highlight Name column
          });
        });
