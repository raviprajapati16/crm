                ...
                <tbody>
                    <?php foreach($attachments as $type => $attachment){
                        ...
                        if($type == 'invoice' || $type == 'proposal' || $type == 'estimate' || $type == 'credit_note'){
                            ...
                            $url = site_url() .'download/file/project/';
                            $download_indicator = 'id';
                        }
                        ?>
                        <?php foreach($attachment as $_att){
                            ...
                            <tr id="tr_file_<?php echo $_att['id']; ?>">
                                ...
                                ?>
                                <a target="_blank" href="<?php if($is_image){ echo isset($lightBoxUrl) ? $lightBoxUrl : $img_url; } else {echo $attachment_url; } ?>"<?php if($is_image){ ?> data-lightbox="customer-profile" <?php } ?> class="display-block mbot5">
                                    <?php if($is_image){ ?>
                        ...
                        <td>
                            ...
                            <?php if($type == 'customer' && has_permission('attachments', '', 'delete')){ ?>
...
<?php
include_once(APPPATH . 'views/admin/target_markets/modals/send_file_modal.php');
} ?>
