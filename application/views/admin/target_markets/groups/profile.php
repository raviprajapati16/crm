         ...
         ; ?>"
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  $selected_state        = (isset($client) ? $client->state : '');
                  $selected_city         = (isset($client) ? $client->city : '');
                     ...
                     <?php foreach ($customer_admins as $c_admin) { ?>
                        <tr>
                           ...
                           <td data-order="<?php echo $c_admin['date_assigned']; ?>">
                              <?php echo _dt($c_admin['date_assigned']); ?>
                           </td>
                           <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
                              <td>
...
<?php if (isset($client)) { ?>
   ...
   <?php } ?>
<?php } ?>
<?php $this->load->view('admin/target_markets/target_market_group'); ?>