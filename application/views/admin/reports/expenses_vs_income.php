...
<script>
     function formatIndianNumber(value) {
        if (value >= 10000000) {
            return (value / 10000000).toFixed(1).replace(/\.0$/, '') + ' Cr'; // Crore
        } else if (value >= 100000) {
            return (value / 100000).toFixed(1).replace(/\.0$/, '') + ' Lac'; // Lakh
        } else if (value >= 1000) {
            return (value / 1000).toFixed(1).replace(/\.0$/, '') + ' K'; // Thousand
        }
        return value;
    }
    $(function(){
