            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="bg-light-gray border-radius-4 hide" id="report-filters">
                           <div class="p8">
                              ...
                              <div class="form-group hide" id="report-time">
                                 ...
                                 <select class="selectpicker" name="months-report" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    ...
                                    <?php
                                       ...
                                       $fy_end   = $fy_start + 1;
                                    ?>
                                    <optgroup label="FY <?php echo $fy_start . '–' . substr($fy_end, 2); ?>">
                                       <option value="fy_q1" data-subtext="<?php echo _d($fy_start.'-04-01'); ?> – <?php echo _d($fy_start.'-06-30'); ?>">Q1 (Apr–Jun)</option>
                                       <option value="fy_q2" data-subtext="<?php echo _d($fy_start.'-07-01'); ?> – <?php echo _d($fy_start.'-09-30'); ?>">Q2 (Jul–Sep)</option>
                                       <option value="fy_q3" data-subtext="<?php echo _d($fy_start.'-10-01'); ?> – <?php echo _d($fy_start.'-12-31'); ?>">Q3 (Oct–Dec)</option>
                                       <option value="fy_q4" data-subtext="<?php echo _d($fy_end.'-01-01'); ?> – <?php echo _d($fy_end.'-03-31'); ?>">Q4 (Jan–Mar)</option>
                                    </optgroup>
