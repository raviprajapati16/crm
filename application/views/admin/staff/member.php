               ...
               <div class="panel-body">
                  ...
                  <div class="tab-content">
                     <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                        ...
                        <div class="form-group">
                           <label for="hourly_rate"><?php echo _l('commision') . " " . _l('staff_hourly_rate'); ?></label>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label for="products">Staff Products</label>
                                 <?php foreach ($products as $product) { ?>
                                    <div class="checkbox checkbox-primary">
                                       <?php
                                       $spchecked = '';
                                       if ($product["productid"] == $product["staffproductid"]) {
                                          $spchecked = ' checked';
                                       }
                                       ?>
                                       <input type="checkbox" id="sprod_<?php echo $product['productid']; ?>" name="products[]" value="<?php echo $product['productid']; ?>" <?php echo $spchecked; ?>>
                                       <label for="sprod_<?php echo $product['productid']; ?>"><?php echo $product['name']; ?></label>
                                    </div>
                                 <?php }  ?>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <hr class="hr-10" />
                              <div class="form-group select-placeholder">
                                 <label for="staffManager">Staff Manager</label>
                                 <select class="selectpicker" data-none-selected-text="Select Manager" data-width="100%" name="managerid[]" id="managerid" multiple>
                                    <option value="" disabled>Select Manager</option>
                                    <?php
                                    $selectedManagersIds = [];
                                    if (isset($member) && !empty($member->managerid)) {
                                       $selectedManagersIds = array_values(array_filter(explode(",", $member->managerid)));
                                    }
                                    foreach ($staff as $staffmember) { ?>
                                       <?php if ($member->staffid !=  $staffmember["staffid"]) {
                                          if ($staffmember['admin'] == '1' || $staffmember['role'] == '3') {

                                       ?>
                                             <option value=<?php echo $staffmember["staffid"]; ?> <?php if (in_array($staffmember["staffid"], $selectedManagersIds)) {
                                                                                                      echo 'selected';
                                                                                                   } ?>><?php echo $staffmember["firstname"] . ' ' .   $staffmember["lastname"]; ?> </option>
                                          <?php
                                          }
                                          ?>
                                       <?php } ?>
                              ...
                              <hr class="hr-10" />
                              <div class="form-group select-placeholder">
                                 <label for="staffManager">Employee Under Manager</label>
                                 <select class="selectpicker" data-none-selected-text="Select Manager" data-width="100%" name="manager_staff[]" id="manager_staff" multiple>
                                    <option value="" disabled>Select Staff</option>
                                    <?php
                                    $selectedManagersIds = [];
                                    if (isset($member) && !empty($member->staffid)) {
                                       $selectedManagersIds = get_manager_assigned_staff_ids($member->staffid);
                                    }
                                    foreach ($staff as $staffmember) { ?>
                                       <?php if ($member->staffid !=  $staffmember["staffid"] && $staffmember['admin'] != '1') {
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <hr class="hr-10" />
                              <label for="staffManager">Tata Tele Services</label>
                              <div class="checkbox checkbox-primary">
                                 <input type="hidden" name="tata_tele_call_permission" value="0">
                                 <input type="checkbox" name="tata_tele_call_permission" id="tata_tele_call_permission_checkbox" value="1" <?php if (isset($member) && $member->tata_tele_call_permission) {
                                                                                                                                                echo "checked";
                                                                                                                                             } ?>>
                                 <label for="tata_tele_call_permission">Call Permission</label>
                              </div>
                              <div class="form-group">
                                 <label for="tata_tele_agentid">Agent Id</label>
                                 <input type="text" class="form-control" name="tata_tele_agentid" value="<?php if (isset($member)) {
                                                                                                            echo $member->tata_tele_agentid;
                                                                                                         } ?>">
                              </div>
                              <div class="form-group">
                                 <label for="tata_tele_phone_number">Phone Number</label>
                                 <input type="text" class="form-control" name="tata_tele_phone_number" value="<?php if (isset($member)) {
                                                                                                                  echo $member->tata_tele_phone_number;
                                                                                                               } ?>">
                              </div>
                              <div class="form-group">
                                 <label for="tata_tele_agent_extension">Agent Extension</label>
                                 <input type="text" class="form-control" name="tata_tele_agent_extension" value="<?php if (isset($member)) {
                                                                                                                     echo $member->tata_tele_agent_extension;
                                                                                                                  } ?>">
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="panel-body">
                     ...
                     <table class="table dt-table scroll-responsive">
                        ...
                        <tbody>
						   ...
						   onclick="timer_action(this, <?php echo $t['task_id']; ?>, <?php echo $t['id']; ?>, 1);" class="btn btn-info btn-xs"><?php echo _l('save'); ?></button>' onclick="return false;" <?php } else { ?> onclick="timer_action(this, <?php echo $t['task_id']; ?>, <?php echo $t['id']; ?>, 1); return false;" <?php } ?> class="text-danger">
