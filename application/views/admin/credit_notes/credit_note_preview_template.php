               ...
               <div id="credit-note-preview">
                  ...
                  <div class="mbot15 row inline-block full-width" data-attachment-id="<?php echo $attachment['id']; ?>">
                     <div class="col-md-8">
                        ...
                        <a href="<?php echo $attachment_url; ?>" target="_blank"><?php echo $attachment['file_name']; ?> <?= ($attachment['rel_type'] != "credit_note") ? "<small class='text-muted'>From " . $attachment['rel_type'] . "</small>" : "" ?></a>
                        <br />
                        <small class="text-muted"> <?php echo $attachment['filetype']; ?></small>
                     </div>
                     <?php if ($attachment['rel_type'] == "credit_note") { ?>
