...
foreach ($comments as $comment) { ?>
   <div class="col-md-12" data-commentid="<?php echo $comment['id']; ?>">
      ...
      <?php } else {
         echo staff_profile_image(0, array(
            'staff-profile-image-small',
            'media-object img-circle pull-left mright10'
         ));
      }
      ...
      <div class="media-body">
         <div class="mtop5">
            ...
            <?php } else if ($comment['rel_type'] == "vendor") { ?>
               <a href="javascript:;" onclick="init_lead(<?= $comment['staffid'] ?>)"><?php echo get_lead_full_name($comment['staffid']); ?></a>
            <?php } else if ($comment['rel_type'] == "customer") { ?>
               <a href="javascript:;"><?php echo get_contact_full_name($comment['staffid']); ?></a>
            <?php } else if ($comment['rel_type'] == "contact_book") { ?>
               <a href="javascript:;"><?php echo get_contact_book_full_name($comment['staffid']); ?></a>
            <?php } ?>
