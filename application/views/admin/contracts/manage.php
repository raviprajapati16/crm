            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="_filters _hidden_inputs hidden">
                        ...
                        echo form_hidden('only_vendor');
                        echo form_hidden('only_customer');
                    ...
                    <div class="panel-body _buttons">
                        ...
                        <a href="<?php echo admin_url('contracts/contract'); ?>"
                            class="btn btn-info pull-left display-block">New Agreement</a>
                        <?php } ?>
                        <div class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip"
                            ...
                            <ul class="dropdown-menu dropdown-menu-left width300 height500">
                                ...
                                <li class="filter-group" data-filter-group="contract_type">
                                    <a href="#" data-cview="only_vendor"
                                        onclick="dt_custom_view('only_vendor','.table-contracts','only_vendor'); return false;">
                                        Vendor Agreements
                                    </a>
                                </li>
                                <li class="filter-group" data-filter-group="contract_type">
                                    <a href="#" data-cview="only_customer"
                                        onclick="dt_custom_view('only_customer','.table-contracts','only_customer'); return false;">
                                        Customer Agreements
                                    </a>
                                </li>
                        ...
                        <div class="row" id="contract_summary">
                            ...
                            if (!has_permission('contracts', '', 'view')) {
                                if (manager_employee_data_access_permission_check("contracts")) {
                                    $where_own = ' AND addedfrom IN (' . get_manager_assigned_staff_ids('', true) . ')';
                                } else {
                                    $where_own = " AND addedfrom = " . get_staff_user_id();
                                }
                            }
                            ?>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                <h3 class="bold">
                                    ...
                                    echo total_rows(
                                        db_prefix() . 'contracts',
                                        '(DATE(dateend) > "' . date('Y-m-d') . '" AND deleted_at IS NULL AND trash = 0'
                                        . (!empty($where_own) ? $where_own : '')
                                        . ') OR (DATE(dateend) IS NULL AND deleted_at IS NULL AND trash = 0'
                                        . (!empty($where_own) ? $where_own : '')
                                        . ')'
                                    );
                                    ?>
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                <h3 class="bold">
                                    ...
                                    echo total_rows(
                                        db_prefix() . 'contracts',
                                        'DATE(dateend) < "' . date('Y-m-d') . '" AND trash = 0 AND dateend is NOT NULL AND deleted_at IS NULL ' . (!empty($where_own) ? $where_own : '')
                                    ); ?>
                                </h3>
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                ...
                                echo total_rows(
                                    db_prefix() . 'contracts',
                                    'dateend BETWEEN "' . $minus_7_days . '" AND "' . $plus_7_days . '" AND trash=0 AND dateend is NOT NULL AND dateend >"' . date('Y-m-d') . '" AND deleted_at IS NULL' . (!empty($where_own) ? $where_own : '')
                                ); ?></h3>
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                <h3 class="bold">
                                    <?php
                                    echo total_rows(db_prefix() . 'contracts', 'dateadded BETWEEN "' . $minus_7_days . '" AND "' . $plus_7_days . '" AND deleted_at IS NULL AND trash=0' . (!empty($where_own) ? $where_own : '')); ?>
                                </h3>
                                <span class="text-success"><?php echo _l('contract_summary_recently_added'); ?></span>
                            </div>
                            <div class="col-md-2 col-xs-6">
                                <h3 class="bold">
                                    <?php echo total_rows(db_prefix() . 'contracts', array_merge(array('trash' => 1, "deleted_at" => NULL, $where_own))); ?>
                                </h3>
...
$(function() {
    ...
    initDataTable('.table-contracts', admin_url + 'contracts/table', undefined, undefined,
        ...
        <?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(2, 'desc'))); ?>
        );
