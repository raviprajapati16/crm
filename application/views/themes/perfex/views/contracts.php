...
<div class="panel_s">
  <div class="panel-body">
    <div class="col-md-12">
      <h3 class="text-success contracts-summary-heading no-mtop mbot15">
    ...
    <table class="table dt-table table-contracts" data-order-col="4" data-order-type="asc">
      ...
      <tbody>
        <?php foreach ($contracts as $contract) {
          if (isset($contract['contract_status']) && strtolower($contract['contract_status']) === 'draft') {
            continue;
          }
          $expiry_class = '';
          ...
          <tr class="<?php echo $expiry_class; ?>">
            ...
            <td data-order="<?php echo $contract['datestart']; ?>"><?php echo _d($contract['datestart']); ?>
            </td>
