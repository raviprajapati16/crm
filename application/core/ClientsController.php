...
class ClientsController extends App_Controller
{
    ...
    public function pdf_page_layout($notInThemeViewFiles = false)
    {
        /**
         * Navigation and submenu
         * @deprecated 2.3.2
         ...
         * @var string
         */
        //$this->template['footer'] = $this->use_footer == true ? $this->load->view('themes/' . active_clients_theme() . '/footer', $this->data, true) : '';
        //$GLOBALS['customers_footer'] = $this->template['footer'];
         ...
         * Load the theme compiled template
         */
        $this->load->view('themes/' . active_clients_theme() . '/index_pdf_page', $this->template);
    }
