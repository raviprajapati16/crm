...
function core_merge_fields($fields)
{
    ...
    $fields[] = 'merge_fields/vendors_merge_fields';
    $fields[] = 'merge_fields/goals_merge_fields';
    $fields[] = 'merge_fields/purchase_merge_fields';
    $fields[] = 'merge_fields/debit_note_merge_fields';
    $fields[] = 'merge_fields/contact_book_merge_fields';
    return $fields;
}
