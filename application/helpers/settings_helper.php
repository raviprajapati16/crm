...
function app_init_settings_tabs()
{
    ...
    // $CI->app_tabs->add_settings_tab('firebase_settings', [
    //     'name'     => _l('firebase_settings'),
    //     'view'     => 'admin/settings/includes/firebase-settings',
    //     'position' => 25,
    // ]);

    $CI->app_tabs->add_settings_tab('email_campaigns_settings', [
        'name'     => _l('email_campaigns_settings'),
        'view'     => 'admin/settings/includes/email-campaign-settings',
        'position' => 25,
    ]);

    $CI->app_tabs->add_settings_tab('global_emails', [
        'name'     => _l('global_mails'),
        'view'     => 'admin/settings/includes/global-emails',
        'position' => 30,
    ]);
    ...
    $CI->app_tabs->add_settings_tab('mpdf', [
        'name'     => "mPDF",
        'view'     => 'admin/settings/includes/mpdf',
        'position' => 80,
    ]);
    ...
    // $CI->app_tabs->add_settings_tab('tradeindia', [
    //     'name'     => 'Tradeindia',
    //     'view'     => 'admin/settings/includes/tradeindia',
    //     'position' => 110,
    // ]);

    $CI->app_tabs->add_settings_tab('tatateleservices', [
        'name'     => 'Tatatel services',
        'view'     => 'admin/settings/includes/tatatel',
        'position' => 115,
    ]);

    $CI->app_tabs->add_settings_tab('expense-settings', [
        'name'     => "Expense Settings",
        'view'     => 'admin/settings/includes/expense-settings',
        'position' => 120,
    ]);
