...
function calculateCommision($amount,$percent_rate)
{
    $commision_amount = ($amount*$percent_rate)/100;
    $commision = abs($amount - $commision_amount);
    return app_format_number($commision);
}
