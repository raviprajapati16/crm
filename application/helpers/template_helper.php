...
function app_external_form_header($form = [])
{
    ...
    if (get_option('recaptcha_secret_key') != '' && get_option('recaptcha_site_key') != '' && $recaptcha) {
...
function get_company_logo($uri = '', $href_class = '', $type = '')
{
    if ($type == "dark") {
        ...
        $company_logo = get_option('company_logo_white');
    } else {
...
function get_white_company_logo($uri = '', $href_class = '')
{
    if (get_option('company_logo_white') == '') {
        return get_company_logo($uri, $href_class);
    }

    return get_company_logo($uri, $href_class, 'white');
}
/**
 * Strip tags
