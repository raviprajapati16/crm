<?php
class Stock_settings extends AdminController
{
    ...
    {
        if (!is_admin()) {
            access_denied('Stock_settings');
        }
        $this->load->view('admin/stock_settings/manage', $data);
    }
    ...
    public function save()
    {
        ...
        redirect(admin_url('stock_settings'));
    }
}
