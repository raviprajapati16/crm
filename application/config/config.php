...
|
*/
$config['log_threshold'] = 1; // (ENVIRONMENT !== 'production' ? 1 : 0);
...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'api\/.+', 'cron/fetch_biomatric_attendance', 'APIController/createNewUser','email_track/testEmailSend'];
