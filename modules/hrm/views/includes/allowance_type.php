...
<div>
    ...
    foreach($allowance_type as $c){ ?>
            <tr>
                ...
                <td>
                    <a href="#"
                        onclick="edit_allowance_type(this,<?php echo htmlspecialchars($c['type_id']); ?>); return false"
                        data-taxable="<?php echo htmlspecialchars($c['taxable']); ?>"
                        data-name="<?php echo htmlspecialchars($c['type_name']); ?>"
                        data-amount="<?php echo htmlspecialchars($c['allowance_val']); ?>"
                        class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
                    <a href="<?php echo admin_url('hrm/delete_allowance_type/'.$c['type_id']); ?>"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        echo render_input('allowance_val','amount','','number'); ?>
                                ...
                                <select name="taxable" class="selectpicker" id="taxable" data-width="100%"
