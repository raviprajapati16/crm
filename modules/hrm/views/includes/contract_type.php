...
<div>
    ...
    <table class="table dt-table">
     ...
     foreach($contract as $c){ ?>
            <tr>
                <td><?php echo $i++; ?></td> <!-- Incrementing counter -->
                ...
                <td>
                    <a href="#"
                        onclick="edit_contract_type(this,<?php echo htmlspecialchars($c['id_contracttype']); ?>); return false"
                        data-name="<?php echo htmlspecialchars($c['name_contracttype']);  ?>"
                        data-contracttype="<?php echo htmlspecialchars($c['contracttype']);  ?>"
                        data-duration="<?php echo htmlspecialchars($c['duration']);  ?>"
                        data-insurance="<?php echo htmlspecialchars($c['insurance']);?>"
                        data-unit="<?php echo htmlspecialchars($c['unit']);?>" class="btn btn-default btn-icon"><i
                            class="fa fa-pencil-square-o"></i></a>
                    <a href="<?php echo admin_url('hrm/delete_contract_type/'.$c['id_contracttype']); ?>"
                        ...
                        echo render_input('contracttype','contract_type'); ?>
                        	...
                        	echo render_input('duration','duration','','number'); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="unit" class="selectpicker" id="unit" data-width="100%"
                                ...
                                <select name="insurance" class="selectpicker" id="insurance" data-width="100%"
                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    <option value=""></option>
