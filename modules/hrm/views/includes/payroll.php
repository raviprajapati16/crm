    ...
    <table class="table dt-table">
     ...
     foreach($salary_form as $c){ ?>
            <tr>
                ...
                <td>
                    <a href="#"
                        onclick="edit_salary_form(this,<?php echo htmlspecialchars($c['form_id']); ?>); return false"
                        data-taxable="<?php echo htmlspecialchars($c['tax']); ?>"
                        data-name="<?php echo htmlspecialchars($c['form_name']); ?>"
                        data-amount="<?php echo htmlspecialchars($c['salary_val']); ?>"
                        class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
                    <a href="<?php echo admin_url('hrm/delete_salary_form/'.$c['form_id']); ?>"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        echo render_input('salary_val','amount','','number'); ?>
                                ...
                                <select name="tax" class="selectpicker" id="taxable" data-width="100%"
