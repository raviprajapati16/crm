...
<div id="wrapper">
               ...
               <div class="panel-body">
                  <ul class="nav nav-tabs" role="tablist">
                     <?php if (isset($member)) { ?>
                        ...
                        <li role="presentation">
                           <a href="#mail_service" aria-controls="mail_service" role="tab" data-toggle="tab">
                              <span class="fa fa-envelope"></span>&nbsp;<?php echo _l('mail_service'); ?>
                           </a>
                        </li>
                  ...
                  <div class="tab-content">
                     <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                        ...
                        <?php } ?>
                        <?php if (is_admin() || has_permission('hrm', '', 'edit')) { ?>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="form-group" app-field-wrapper="staff_identifi">
                                 ...
                                 <input type="text" id="staff_identifi" name="staff_identifi" class="form-control" value="<?php echo htmlspecialchars($hr_codes); ?>" aria-invalid="false">
                              </div>
                           </div>
                           <div class="col-md-4">
                              <?php $doj = (isset($member) ? $member->doj : '');
                              echo render_date_input('doj', 'Date Of Joining', _d($doj)); ?>
                           </div>
                           <div class="col-md-4">
                              <?php $exit_date = (isset($member) ? $member->exit_date : '');
                              echo render_date_input('exit_date', 'Date Of Exit', _d($exit_date)); ?>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-4">
                              <?php $value = (isset($member) ? $member->firstname : ''); ?>
                              <?php echo render_input('firstname', 'First Name', $value, 'text', $attrs); ?>
                           </div>
                           <div class="col-md-4">
                              <?php $value = (isset($member) ? $member->lastname : ''); ?>
                              <?php echo render_input('lastname', 'Last Name', $value, 'text', []); ?>
                           </div>
                           <div class="col-md-4">
                              <?php $value = (isset($member) ? $member->firstname . ' ' . $member->lastname : ''); ?>
                              <?php echo render_input('fullname', 'Full Name', $value, 'text', ["readonly" => true]); ?>
                           </div>
                           <div class="col-md-4">
                           ...
                           <div class="col-md-4">
                              ...
                              <select name="job_position" class="selectpicker" id="job_position" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                 ...
                                 <?php foreach ($positions as $p) { ?>
                                    <option value="<?php echo htmlspecialchars($p['position_id']); ?>" <?php if (isset($member) && $member->job_position == $p['position_id']) {
                                                                                                            echo 'selected';
                                                                                                         } ?>><?php echo htmlspecialchars($p['position_name']); ?></option>
                                 <?php } ?>
                              </select>
                           </div>
                           <div class="col-md-4">
                              ...
                              <select name="workplace" class="selectpicker" id="workplace" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                 ...
                                 <?php foreach ($workplace as $w) { ?>
                                    ...
                                    <option value="<?php echo htmlspecialchars($w['workplace_id']); ?>" <?php if (isset($member) && $member->workplace == $w['workplace_id']) {
                                                                                                            echo 'selected';
                                                                                                         } ?>><?php echo htmlspecialchars($w['workplace_name']); ?></option>
                                 <?php } ?>
                              </select>
                           </div>
                        </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    <input type="number" name="hourly_rate" value="<?php if (isset($member)) {
                                                                                       echo htmlspecialchars($member->hourly_rate);
                                                                                    } else {
                                                                                       echo 0;
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="facebook" value="<?php if (isset($member)) {
                                                                                                   echo htmlspecialchars($member->facebook);
                                                                                                } ?>">
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="linkedin" value="<?php if (isset($member)) {
                                                                                                   echo htmlspecialchars($member->linkedin);
                                                                                                } ?>">
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="skype" value="<?php if (isset($member)) {
                                                                                                echo htmlspecialchars($member->skype);
                                                                                             } ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              <div class="form-group" app-field-wrapper="email">
                                 ...
                                 <input type="email" id="email" name="email" class="form-control" autocomplete="off" value="<?php echo htmlspecialchars($value); ?>">
                              </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <iframe style="width: 100%;" id="previewSignature" srcdoc="<?php echo htmlspecialchars(get_webmail_signature((isset($member) ? $member->staffid : '')), ENT_QUOTES, 'UTF-8'); ?>"></iframe>
                                 </div>
                              </div>
                           </div>
                        <?php } ?>
                           ...
                           <div class="col-md-12">
                              ...
                              ?>
                                 <div class="checkbox checkbox-primary">
                                    <?php
                                    $isadmin = '';
                                    if (isset($member) && (is_admin($member->staffid))) {
                                       $isadmin = ' checked';
                                    }
                                    ?>
                     ...
                     <?php if (isset($member)) { ?>
                           ...
                           <div>
                              <div id="contract_attachments" class="mtop30 col-md-8 col-md-offset-2">
                                 ...
                                 foreach ($hrm_staff as $attachment) {
                                    $href_url = site_url('download/file/hrm_staff_file/' . $attachment['id']);
                        ...
                        <div role="tabpanel" class="tab-pane" id="mail_service">
                           <?php echo form_open_multipart('admin/hrm/mail_service/' . $member->staffid, array('id' => 'mail_service_form')); ?>
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="row">
                                    <div class="col-md-12">
   ...
   <div class="modal fade" id="setting-modal" tabindex="-1" role="dialog" data-backdrop="static">
      <div class="modal-dialog modal-xl">
         ...
         <input type="hidden" name="user_id" value="<?= (isset($member) ? $member->staffid : '') ?>" form="signatureForm" />
            ...
            <div class="modal-body">
               <div class="row">
                  <?= all_type_input_render([
                     ...
                     "name" => "firstName",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('firstName', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "lastName",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('lastName', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "title",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('title', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "company",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('company', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "email",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('email', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "mobile",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('mobile', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "phone",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('phone', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "website",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('website', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "facebook",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('facebook', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "twitter",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('twitter', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "instagram",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('instagram', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "linkedin",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('linkedin', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "youtube",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('youtube', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "pinterest",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('pinterest', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "address1",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('address1', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  <?= all_type_input_render([
                     ...
                     "name" => "address2",
                     "type" => "text",
                     "selected_value" => get_webmail_signature_data('address2', (isset($member) ? $member->staffid : '')),
                     "is_required" => false,
                     "form" => "signatureForm",
                  ], 'col-md-3', false);
                  ?>
                  ...
                  <div class="col-md-4">
                     <div class="row">
                        <?= all_type_input_render([
                           ...
                           "type" => "textarea",
                           "rows" => 5,
                           "selected_value" => get_webmail_signature_data('disclaimer', (isset($member) ? $member->staffid : '')),
                           "is_required" => false,
                           "form" => "signatureForm",
                        ], 'col-md-12', false);
                        ?>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <select name="template" class="selectpicker" id="template" data-width="100%" form="signatureForm">
                                 <option value="" <?= (empty(get_webmail_signature_data('template', (isset($member) ? $member->staffid : '')))) ? 'selected' : '' ?>>No Signature</option>
                                 <?php
                                 foreach ($templateArr as $key => $item) {
                                 ?>
                                    <option value="<?= $key ?>" <?= (get_webmail_signature_data('template', (isset($member) ? $member->staffid : '')) == $key) ? 'selected' : '' ?>><?= $item ?></option>
                                 <?php
                                 }
                                 ?>
                              </select>
   ...
   <script>
      ...
      $(function() {
         ...
         initDataTable(table_contract, admin_url + 'hrm/table_contract', undefined, undefined, ContractsServerParams, <?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(0, 'asc'))); ?>);
      ...
      $('#add_records_received').on('click', function() {
         if ($('#records_received').change()) {
            ...
            var data = [];
            var data_record = {};
            $("input[name ='records_received']").each(function() {
      ...
      function generateFullName() {
         ...
         $('input[name="fullname"]').val(firstname + ' ' + lastname);
      }
