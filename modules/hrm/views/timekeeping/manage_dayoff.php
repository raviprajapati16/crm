      ...
      <tbody>
        <?php foreach ($holiday as $d) { ?>
          <tr>
            ...
            <td><?php echo get_staff_in_dayoff($d['staff_id']); ?></td>
            ...
            <div class="row col-md-12" id="break_date-item">
              ...
              <div class="col-md-3">
                <div class="select-placeholder form-group">
                  ...
                  <select name="department[0]" id="department[0]" class="selectpicker" data-width="100%" data-none-selected-text="Select Department" data-hide-disabled="true">
                    <option value=""></option>
              ...
              <div class="col-md-3">
                <div class="select-placeholder form-group">
                  ...
                  <select name="position[0]" id="position[0]" class="selectpicker" data-width="100%" data-none-selected-text="Select Position" data-hide-disabled="true">
                    <option value=""></option>
              ...
              <div class="col-md-3">
                <div class="select-placeholder form-group">
                  <label for="staff_id[0]">Staff</label>
                  <select name="staff_id[0][]" id="staff_id[0]" class="selectpicker" data-width="100%" data-none-selected-text="Select Staff" data-hide-disabled="true" multiple>
                    <option value=""></option>
                    <option value="0">All Staff</option>
                    <?php foreach ($all_staff as $staff) { ?>
                      <option value="<?php echo htmlspecialchars($staff['staffid']); ?>"><?php echo htmlspecialchars($staff['firstname']); ?> <?php echo htmlspecialchars($staff['lastname']); ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
          ...
          <div class="row col-md-12">
            ...
            <div class="col-md-3">
              <div class="select-placeholder form-group">
                ...
                <select name="department" id="department" class="selectpicker" data-width="100%" data-none-selected-text="Select Department" data-hide-disabled="true">
                  <option value=""></option>
                  <option value="0">All Department</option>
                  <?php foreach ($departments as $dpm) { ?>
                    <option value="<?php echo htmlspecialchars($dpm['departmentid']); ?>"><?php echo htmlspecialchars($dpm['name']); ?></option>
            ...
            <div class="col-md-3">
              <div class="select-placeholder form-group">
                ...
                <select name="position" id="position" class="selectpicker" data-width="100%" data-none-selected-text="Select Position" data-hide-disabled="true">
                  <option value=""></option>
                  <option value="0"> All Position</option>
                  <?php foreach ($positions as $dpm) { ?>
                    <option value="<?php echo htmlspecialchars($dpm['position_id']); ?>"><?php echo htmlspecialchars($dpm['position_name']); ?></option>
            ...
            <div class="col-md-3">
              <div class="select-placeholder form-group">
                ...
                <select name="staff_id[]" id="staff_id" class="selectpicker" data-width="100%" data-none-selected-text="Select Staff" data-hide-disabled="true" multiple>
                  <option value="0"> All Staff</option>
                  <?php foreach ($all_staff as $staff) { ?>
                    <option value="<?php echo htmlspecialchars($staff['staffid']); ?>"><?php echo htmlspecialchars($staff['firstname']); ?> <?php echo htmlspecialchars($staff['lastname']); ?></option>
                  <?php } ?>
