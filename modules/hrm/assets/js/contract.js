$(function () {
    ...
    $.validator.addMethod("endDateNotEarlier", function (value, element) {
        var startDateVal = $('#start_valid').val();
        var endDateVal = $('#end_valid').val();
    ...
    $($('.staff-form')).appFormValidator({
        rules: {
            contract_status: 'required',
            staff: 'required',
            start_valid: {
                required: function (element) {
                    return ($('#contract_status').val() == "Probation" || $('#contract_status').val() == "Bond");
                }
            },
            end_valid: {
                required: function (element) {
                ...
                endDateNotEarlier: true
            }
        },
        errorPlacement: function (error, element) {
            var formGroup = $(element).closest('[class*="col-md-"]');
    ...
    $('select').on('change', function () {
        $(this).closest('[class*="col-md-"]').find('span.error').remove();
    });

    $('#start_valid').closest('.form-group').addClass('hide');
    $('#end_valid').closest('.form-group').addClass('hide');
    $('#contract_status').on('change', function () {
        if ($(this).val() == "Probation" || $(this).val() == "Bond") {
            $('#start_valid').closest('.form-group').removeClass('hide');
            $('#end_valid').closest('.form-group').removeClass('hide');
        } else {
            $('#start_valid').closest('.form-group').addClass('hide');
            $('#end_valid').closest('.form-group').addClass('hide');
