<?php init_tail(); ?>
<!-- Product Data Add/Edit-->

<div class="modal fade product-model" id="product-model" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
...
<script type="text/javascript">
    function editproduct(id) {
        debugger;
        if (init_product_modal_data(id, true)) {
    ...
    // Fetches product model data for edit

    function init_product_modal_data(id, isEdit = false) {
        var requestURL = 'product_management/product/' + (typeof(id) != 'undefined' ? id : '');
        if (isEdit === true) {
            var concat = '?';
        ...
        requestGetJSON(requestURL).done(function(response) {
            ...
            _product_init_data(response, id);
    ...
    function _product_init_data(response, id) {
