...
<div id="wrapper">
                           ...
                           <div class="form-group">
                              ...
                              <div class="customer-groups" style="display:none;">
                                 ...
                                 <div class="checkbox checkbox-primary mleft10">
                                    <input type="checkbox" name="ml_customers_all" id="ml_customers_all" checked>
                                 ...
                                 <div class="checkbox checkbox-primary mleft10">
                                    ...
                                    <label for="specific_customers">Specific Customers</label>
                                 </div>
                                 <div class="form-group select-placeholder customers_selection hide">
                                    ...
                                    <div id="customers_selection_select">
                                       <select name="customers[]" id="customers_selection" class="ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="Select Customers" multiple>
                                       </select>
                                    </div>
                                 </div>
                                 <hr class="hr-10" />
                              ...
                              <div class="leads-statuses" style="display:none;">
                                 ...
                                 <div class="form-group select-placeholder leads_selection hide">
                                    ...
                                    <div id="leads_selection_select">
                                       <select name="lead_ids[]" id="leads_selection" class="ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="Select Leads" multiple>
                                       </select>
                                    </div>
                                 </div>
                                 <hr class="hr-10" />
                              ...
                              <div class="staff-groups hide">
                                 <div class="clearfix"></div>
                                 <div class="checkbox checkbox-primary mleft10">
                                    <input type="checkbox" name="staff_all" id="ml_staff_all" checked>
                                    <label for="ml_staff_all">All Staff</label>
                                 </div>
                                 <div class="checkbox checkbox-primary mleft10">
                                    <input type="checkbox" name="specific_staff" id="specific_staff">
                                    <label for="specific_staff">Specific Staff</label>
                                 </div>
                                 <div class="form-group select-placeholder staff_selection hide">
                                    ...
                                    <div id="staff_selection_select">
                                       <select name="staff_ids[]" id="staff_selection" class="ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="Select Staff" multiple>
                                       </select>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <?php foreach ($send_log as $log) { ?>
                                 <p>
                                    <?php if (has_permission('surveys', '', 'delete') && total_rows(db_prefix() . 'surveysendlog', array('id' => $log['id'], 'surveyid' => $survey->surveyid, 'total' => 0))) { ?>
   ...
   <script>
      $(function() {
         ...
         init_ajax_search('customer', '#customers_selection.ajax-search');
         init_ajax_search('staff', '#staff_selection.ajax-search');
         init_ajax_search('leads', '#leads_selection.ajax-search');
