        ...
        foreach ($_all_emails as $email) {
            ...
            if (!is_array($email)) {
                ...
                $this->db->insert(db_prefix() . 'surveysemailsendcron', [
                    ...
                    'listid'   => (isset($email['listid'])) ? $email['listid'] : NULL,
                    'emailid'  => (isset($email['emailid'])) ? $email['emailid'] : NULL,
                    'lead_id'  => (isset($email['lead_id'])) ? $email['lead_id'] : NULL,
                    'contact_id'  => (isset($email['contact_id'])) ? $email['contact_id'] : NULL,
                    'staff_id'  => (isset($email['staff_id'])) ? $email['staff_id'] : NULL,
                    'log_id'   => $log_id,
                ]);
            }
        }
